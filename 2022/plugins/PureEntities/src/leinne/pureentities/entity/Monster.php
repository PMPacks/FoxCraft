...
abstract class Monster extends LivingBase{
    ...
    public function isAttackable() : bool{
        return $this->getMaxDamage() > 0 || ($this->allowWeaponDamage);
    }
    ...
    protected function sendSpawnPacket(Player $player) : void{
        ...
        //$player->getNetworkSession()->sendDataPacket(MobEquipmentPacket::create($this->id, ItemStackWrapper::legacy(TypeConverter::getInstance()->coreItemStackToNet($this->getInventory()->getItemInHand())), 0, ContainerIds::INVENTORY));
    }
    ...
    public function saveNBT() : CompoundTag{
        ...
        //$nbt->setTag("HeldItem", $this->getInventory()->getItemInHand()->nbtSerialize());
        return $nbt;
    }
