...
class PureEntities extends PluginBase implements Listener{
    ...
    public function onEnable() : void{
		...
		/** Register other */
		$entityFactory->register(God::class, function(World $world, CompoundTag $nbt) : God{
            return new God(EntityDataHelper::parseLocation($nbt, $world), $nbt);
        }, ["God", "minecraft:god"]);
		$entityFactory->register(SpecialEnderman::class, function(World $world, CompoundTag $nbt) : SpecialEnderman{
            return new SpecialEnderman(EntityDataHelper::parseLocation($nbt, $world), $nbt);
        }, ["SpecialEnderman", "minecraft:specialenderman"]);
		$entityFactory->register(SpecialGolem::class, function(World $world, CompoundTag $nbt) : SpecialGolem{
            return new SpecialGolem(EntityDataHelper::parseLocation($nbt, $world), $nbt);
        }, ["SpecialGolem", "minecraft:specialgolem"]);
		$entityFactory->register(SpecialZombie::class, function(World $world, CompoundTag $nbt) : SpecialZombie{
            return new SpecialZombie(EntityDataHelper::parseLocation($nbt, $world), $nbt);
        }, ["SpecialZombie", "minecraft:specialzombie"]);
		$entityFactory->register(Boat::class, function(World $world, CompoundTag $nbt) : Boat{
            return new Boat(EntityDataHelper::parseLocation($nbt, $world), $nbt);
        }, ["Boat", "minecraft:boat"]);
		
		// Dungeons
		$entityFactory->register(BossFloorOne::class, function(World $world, CompoundTag $nbt) : BossFloorOne{
            return new BossFloorOne(EntityDataHelper::parseLocation($nbt, $world), $nbt);
        }, ["BossFloorOne", "minecraft:bossfloorone"]);
		$entityFactory->register(DungeonEnderman::class, function(World $world, CompoundTag $nbt) : DungeonEnderman{
            return new DungeonEnderman(EntityDataHelper::parseLocation($nbt, $world), $nbt);
        }, ["DungeonEnderman", "minecraft:dungeonenderman"]);
		$entityFactory->register(DungeonSkeleton::class, function(World $world, CompoundTag $nbt) : DungeonSkeleton{
            return new DungeonSkeleton(EntityDataHelper::parseLocation($nbt, $world), $nbt);
        }, ["DungeonSkeleton", "minecraft:dungeonskeleton"]);
		$entityFactory->register(DungeonZombie::class, function(World $world, CompoundTag $nbt) : DungeonZombie{
            return new DungeonZombie(EntityDataHelper::parseLocation($nbt, $world), $nbt);
        }, ["DungeonZombie", "minecraft:dungeonzombie"]);
		
		$entityFactory->register(DungeonDrowned::class, function(World $world, CompoundTag $nbt) : DungeonDrowned{
            return new DungeonDrowned(EntityDataHelper::parseLocation($nbt, $world), $nbt);
        }, ["DungeonDrowned", "minecraft:dungeondrowned"]);
		$entityFactory->register(DungeonPig::class, function(World $world, CompoundTag $nbt) : DungeonPig{
            return new DungeonPig(EntityDataHelper::parseLocation($nbt, $world), $nbt);
        }, ["DungeonPig", "minecraft:dungeonpig"]);
		$entityFactory->register(DungeonIronZombie::class, function(World $world, CompoundTag $nbt) : DungeonIronZombie{
            return new DungeonIronZombie(EntityDataHelper::parseLocation($nbt, $world), $nbt);
        }, ["DungeonIronZombie", "minecraft:dungeonironzombie"]);
		$entityFactory->register(BossFloorTwo::class, function(World $world, CompoundTag $nbt) : BossFloorTwo{
            return new BossFloorTwo(EntityDataHelper::parseLocation($nbt, $world), $nbt);
        }, ["BossFloorTwo", "minecraft:bossfloortwo"]);
        ...
        if($spawnable["enable"] ?? false){
            $this->getScheduler()->scheduleRepeatingTask(new AutoSpawnTask($this), (int) ($spawnable["tick"] ?? 80));
        }
