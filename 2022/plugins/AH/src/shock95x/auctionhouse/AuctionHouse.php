...
class AuctionHouse extends PluginBase {
	...
	private const RESOURCES = ["statements/mysql.sql" => true, "statements/sqlite.sql" => true, "language/en_US.yml" => false, "language/vn_VN.yml" => false, "language/ru_RU.yml" => false, "language/de_DE.yml" => false];
